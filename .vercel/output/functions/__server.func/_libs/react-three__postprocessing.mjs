...
import { ac as HalfFloatType, N as NoToneMapping } from "./three.mjs";
import { E as EffectComposer, R as RenderPass, N as NormalPass, D as DepthDownsamplingPass, a as Effect, b as EffectPass, P as Pass, B as BloomEffect, C as ChromaticAberrationEffect } from "./postprocessing.mjs";
import "./maath.mjs";
import { u as useThree, a as useFrame, e as extend } from "./react-three__fiber.mjs";
...
const le = /* @__PURE__ */ new WeakMap(), P = (e, t) => function({ blendFunction: o = t?.blendFunction, opacity: r = t?.opacity, ...a }) {
  ...
  const i = useThree((l) => l.camera), s = React.useMemo(() => [...t?.args ?? [], ...a.args ?? [{ ...t, ...a }]], [JSON.stringify(a)]);
